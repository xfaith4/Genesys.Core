...
- **Catalog-as-source-of-truth** — 122 curated dataset keys backed by a 3,000+ endpoint reference catalog in `genesys.catalog.json`; schema-validated before every run
