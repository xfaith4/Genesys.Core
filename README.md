...
- **Catalog-as-source-of-truth** — 123 dataset keys over 3,100+ cataloged Genesys Cloud endpoint definitions in `genesys.catalog.json`; schema-validated before every run
